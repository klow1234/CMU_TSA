      ...
      describe "events" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before(:each) { FactoryGirl.create(:event, :name => "UniqueTitle") }
        ...
        describe "edit" do
          before(:each) { FactoryGirl.create(:event, :name => "A name") }
        ...
        describe "destroy" do
          before(:each) { FactoryGirl.create(:event, :name => "UniqueTitleOne") }
